...
//            changedDate: Int((todoItem.changedDate ?? todoItem.creationDate).timeIntervalSince1970),
...
//        let changedDate = Date(timeIntervalSince1970: TimeInterval(element.changedDate))
//
//        return ToDoItem(
//            id: id.uuidString,
//            text: element.text,
